...
#define NV_ID_OPENVALLEY_WIFI_INFO          0x2300   /*connect info:wifi,passwd,server IP,port*/
#define NV_ID_OPENVALLEY_SERVER_INFO        0x2301   /*connect info:server IP,port*/
